...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [12600,4,'④ Cu²⁺が水溶液中から銅板へ近づきます。そこでe⁻を2個受け取ると、いったんCu原子としてはっきり表示されます。そのCu原子が銅板の表面へ移動し、付着したまま銅板の一部になります。'],
    [17400,5,'⑤ Cu²⁺が水溶液中から減っていくので、右側ビーカーの硫酸銅水溶液の青色が時間とともに少しずつ薄くなり、その薄い状態で止まります。']
  ];
...
document.querySelectorAll('.action').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    if(a==='run-volta'){
      ...
      speak('まず、硫酸は水中で電離して水素イオンと硫酸イオンになります。ボルタ電池でもダニエル電池の②と同じように、亜鉛板のZn原子が電子を2個失ってZn2プラスとなり、水溶液中へ出ていきます。電子2個は亜鉛板の金属中を上へ移動して配線へ入り、銅板へ進みます。水素イオンは電子を受け取り、いったん水素原子になり、2個が結びついて水素分子H2として気体になります。');
    }
...
const daniellStoryMessages = {
  ...
  4:'④ Cu²⁺が水溶液中から銅板へ近づきます。そこでe⁻を2個受け取ると、いったんCu原子としてはっきり表示されます。そのCu原子が銅板の表面へ移動し、付着したまま銅板の一部になります。',
  5:'⑤ Cu²⁺が水溶液中から減っていくので、右側ビーカーの硫酸銅水溶液の青色が時間とともに少しずつ薄くなり、その薄い状態で止まります。'
};
