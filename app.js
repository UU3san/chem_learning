...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [12600,4,'④ Cu²⁺は水溶液中にあります。電子eマイナスは水溶液の上から来るのではなく、銅板の金属中から表面へ来てCu²⁺に渡されます。Cu²⁺が電子を2個受け取るとCu原子になり、そのCu原子が銅板表面に付着します。'],
    [17400,5,'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーの硫酸銅水溶液の青色が約10秒かけて少しずつ、なめらかに薄くなります。']
  ];
...
document.querySelectorAll('.action').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    if(a==='run-volta'){
      ...
      speak('まず、硫酸は水中で電離して水素イオンと硫酸イオンになります。亜鉛板の表面にあるZn原子が電子を2個失い、Zn2プラスになって水溶液中へ移動します。残った電子2個は亜鉛板の金属中を上へ移動し、配線へ入って銅板へ進みます。');
    }
...
const daniellStoryMessages = {
  ...
  4:'④ Cu²⁺は水溶液中にあります。電子eマイナスは水溶液の上から来るのではなく、銅板の金属中から表面へ来てCu²⁺に渡されます。Cu²⁺が電子を2個受け取るとCu原子になり、そのCu原子が銅板表面に付着します。',
  5:'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーの硫酸銅水溶液の青色が約10秒かけて少しずつ、なめらかに薄くなります。'
};
