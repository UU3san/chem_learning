...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [12600,4,'④ Cu²⁺が水溶液中から銅板へ近づき、e⁻を2個受け取ってCu原子になります。できたCu原子は銅板の表面へ移動し、その場所に付着して銅板の一部になります。'],
...
const daniellStoryMessages = {
  ...
  4:'④ Cu²⁺が水溶液中から銅板へ近づき、e⁻を2個受け取ってCu原子になります。できたCu原子は銅板の表面へ移動し、その場所に付着して銅板の一部になります。',
