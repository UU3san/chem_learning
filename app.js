...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [17400,5,'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーでは濃い青の層が約18秒かけて少しずつ消えていき、薄い青色へ変わります。同時にCu²⁺の表示も減っていきます。']
  ];
...
document.querySelectorAll('.action').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    if(a==='run-volta'){
      ...
      speak('まず、硫酸は水中で電離して水素イオンと硫酸イオンになります。亜鉛板のZn原子がZn2プラスとなって水溶液へ出て、電子2個は導線を通って銅板へ進みます。銅板では、2個のHプラスがそれぞれ電子を受け取ってH原子になり、そのH原子2個が結びついてH2となり、水素分子の気体として上へ出ていきます。');
    }
...
const daniellStoryMessages = {
  ...
  5:'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーでは濃い青の層が約18秒かけて少しずつ消えていき、薄い青色へ変わります。同時にCu²⁺の表示も減っていきます。'
};
