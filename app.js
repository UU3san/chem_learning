...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [12600,4,'④ Cu²⁺が銅板へ近づき、e⁻を2個受け取ってCu原子になります。そのCu原子はビーカー側へ逃げるのではなく、銅板の表面へ移動して付着し、銅板の一部になります。'],
    [17400,5,'⑤ Cu²⁺が水溶液中から減っていくので、右側ビーカーの硫酸銅水溶液そのものの青色がだんだん薄くなります。']
  ];
...
document.querySelectorAll('.action').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    if(a==='run-volta'){
      ...
      speak('まず、硫酸は水中で電離して水素イオンと硫酸イオンになります。亜鉛板のZn原子が電子を2個失い、Zn2プラスとなって水溶液中へ出ていきます。放出された電子2個は空気中へ飛び出すのではなく、亜鉛板の金属中を上へ移動して配線へ入り、銅板へ進みます。水素イオンは電子を受け取り、いったん水素原子になり、2個が結びついて水素分子H2として気体になります。');
    }
...
const daniellStoryMessages = {
  ...
  4:'④ Cu²⁺が銅板へ近づき、e⁻を2個受け取ってCu原子になります。そのCu原子はビーカー側へ逃げるのではなく、銅板の表面へ移動して付着し、銅板の一部になります。',
  5:'⑤ Cu²⁺が水溶液中から減っていくので、右側ビーカーの硫酸銅水溶液そのものの青色がだんだん薄くなります。'
};
