...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [4200,2,'② 亜鉛板そのものを見てください。金属板のZn原子が電子を2個失い、Zn²⁺になって水溶液中へ出ていきます。放出されたe⁻2個は空気中へ飛び出すのではなく、亜鉛板の金属中を上へ移動し、配線につながる位置へ進みます。'],
    [8400,3,'③ 出た電子e⁻は、導線を通って亜鉛板から銅板へ流れます。'],
    [12600,4,'④ Cu²⁺は水溶液中にあります。電子eマイナス2個は銅板の中から表面へ来て、横方向にCu²⁺へ渡されます。Cu²⁺が電子を2個受け取るとCu原子になり、そのCu原子が銅板表面へ戻って付着します。'],
    [17400,5,'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーの硫酸銅水溶液は濃い青色から約18秒かけて少しずつ薄い青色へ変わります。同時にCu²⁺の表示も減っていきます。']
  ];
...
document.querySelectorAll('.action').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    if(a==='run-volta'){
      ...
      speak('まず、硫酸は水中で電離して水素イオンと硫酸イオンになります。亜鉛板のZn原子がZn2プラスとなって水溶液へ出て、電子2個は導線を通って銅板へ進みます。銅板では、水素イオンHプラスが銅板から来た電子を受け取ってH原子になります。できたH原子2個が結びついてH2となり、水素分子の気体として上へ出ていきます。');
    }
...
const daniellStoryMessages = {
  ...
  2:'② 亜鉛板そのものを見てください。金属板のZn原子が電子を2個失い、Zn²⁺になって水溶液中へ出ていきます。放出されたe⁻2個は空気中へ飛び出すのではなく、亜鉛板の金属中を上へ移動し、配線につながる位置へ進みます。',
  3:'③ 出た電子e⁻は、導線を通って亜鉛板から銅板へ流れます。',
  4:'④ Cu²⁺は水溶液中にあります。電子eマイナス2個は銅板の中から表面へ来て、横方向にCu²⁺へ渡されます。Cu²⁺が電子を2個受け取るとCu原子になり、そのCu原子が銅板表面へ戻って付着します。',
  5:'⑤ Cu²⁺が水溶液中から減るにつれて、右側ビーカーの硫酸銅水溶液は濃い青色から約18秒かけて少しずつ薄い青色へ変わります。同時にCu²⁺の表示も減っていきます。'
};
