...
function runDaniellStory(){
  ...
  const stages=[
    ...
    [4200,2,'② 亜鉛板そのものを見てください。金属板のZn原子が電子を2個失い、Zn²⁺になって水溶液中へ出ていきます。放出されたe⁻2個は金属板側に残り、次に導線へ流れます。'],
...
const daniellStoryMessages = {
  ...
  2:'② 亜鉛板そのものを見てください。金属板のZn原子が電子を2個失い、Zn²⁺になって水溶液中へ出ていきます。放出されたe⁻2個は金属板側に残り、次に導線へ流れます。',
